    ...
    () {
      ...
      test(
        ...
        () async {
          // GIVEN
          when(
            () => mockSharedPrefs.restoreData<String>(     dataType: DataType.string,key: any()),
          ).thenReturn(tTheme);
          ...
          verifyOnly(
            mockSharedPrefs,
            () => mockSharedPrefs.restoreData<String>(     dataType: DataType.string,key: ThemeLocalDataSource.appThemeKey),
          );
    ...
    () {
      ...
      test(
        ...
        () async {
          ...
          final container = setUpSharedPrefsContainer();
          when(
            () => mockSharedPrefs.saveData(     dataType: DataType.string,
              key: any(named: 'key'),
