...
abstract class AppStaticColors {
  ...
  static const Color orange = const Color(0xFFFF8E42);
  static const Color black1 = const Color(0xFF032326);
  static const Color normalBlack = Colors.black;
  static const Color blueLogin = const Color(0xFF0000CE);
  static const Color backGround = const Color(0xFFF5F5F9);
  static const Color errorBoarderColor = const Color(0xFFF84711);
  ...
  static const ColorFilter colorFilterWhite50 = ColorFilter.mode(AppStaticColors.whiteOpacity50, BlendMode.srcIn);
