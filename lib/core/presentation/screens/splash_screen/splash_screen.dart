...
class SplashScreen extends ConsumerWidget {
  ...
  static Future<void> precacheAssets(
    ...
    if (isAndroid12AndHigher) {
      ...
      const loader = SvgAssetLoader(MyAssets.ASSETS_IMAGES_CORE_CUSTOM_SPLASH_ICON_SVG);
      await svg.cache.putIfAbsent(loader.cacheKey(context), () => loader.loadBytes(null));
    }
  }
