            ...
            Row(
              ...
              children: List.generate(
                ...
                (index) => Container(
                  ...
                  margin: const EdgeInsets.symmetric(vertical: Sizes.marginV10, horizontal: Sizes.marginH2),
                  decoration: BoxDecoration(
                    color:
                        currentIndex.value == index ? customColors(context).blueColor : Colors.black.withOpacity(0.2),
