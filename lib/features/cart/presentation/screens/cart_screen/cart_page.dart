  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Directionality(
        ...
        child: Padding(
          padding: const EdgeInsets.symmetric(horizontal: Sizes.paddingH16, vertical: Sizes.paddingV30),
          child: Column(
            ...
            children: [
              ...
              Stack(
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: Sizes.paddingV10, horizontal: Sizes.paddingH10),
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: Sizes.marginH16), // Adjust the space between buttons
                            ElevatedButton(
                              onPressed: () {
              ...
              Container(
                ...
                padding: const EdgeInsets.only(left: Sizes.paddingH10, right: Sizes.paddingH10, top: Sizes.paddingV10),
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(Sizes.widgetRadius5), // Adjust the radius as needed
                  color: customColors(context).whiteColor,
                ),
                      ...
                      children: [
                        Expanded(
                          child: ElevatedButton(
                            ...
                            child: Text('إتمام الشراء', style: TextStyles.whiteBoldF16(context)),
                          ),
                        ),
                      ],
                    ),
